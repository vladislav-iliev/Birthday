...
@Composable
fun KidScreen(state: State, onAvatarPickerClick: () -> Unit, modifier: Modifier = Modifier) {
    ConstraintLayout(
...
fun KidScreenPreview() {
    KidScreen(State(true, Text("Johny Doe", Age(1, false), Theme.PELICAN), null), {}, Modifier.fillMaxSize())
}